		...
		Steps: []resource.TestStep{
			// create case
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.selectel_cloudbackup_plan_v2.plans", "plans.0.name", name),
					resource.TestCheckResourceAttr("data.selectel_cloudbackup_plan_v2.plans", "plans.0.backup_mode", backupMode),
					resource.TestCheckResourceAttr("data.selectel_cloudbackup_plan_v2.plans", "plans.0.description", description),
					resource.TestCheckResourceAttr("data.selectel_cloudbackup_plan_v2.plans", "plans.0.full_backups_amount", strconv.Itoa(fullBackupsAmount)),
					resource.TestCheckResourceAttr("data.selectel_cloudbackup_plan_v2.plans", "plans.0.schedule_type", scheduleType),
					resource.TestCheckResourceAttr("data.selectel_cloudbackup_plan_v2.plans", "plans.0.schedule_pattern", schedulePattern),
				),
			},
			// update cases
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.selectel_cloudbackup_plan_v2.plans", "plans.0.name", name),
					resource.TestCheckResourceAttr("data.selectel_cloudbackup_plan_v2.plans", "plans.0.backup_mode", backupMode),
					resource.TestCheckResourceAttr("data.selectel_cloudbackup_plan_v2.plans", "plans.0.description", descriptionUpdated),
					resource.TestCheckResourceAttr("data.selectel_cloudbackup_plan_v2.plans", "plans.0.full_backups_amount", strconv.Itoa(fullBackupsAmountUpdated)),
					resource.TestCheckResourceAttr("data.selectel_cloudbackup_plan_v2.plans", "plans.0.schedule_type", scheduleType),
					resource.TestCheckResourceAttr("data.selectel_cloudbackup_plan_v2.plans", "plans.0.schedule_pattern", schedulePatternUpdated),
				),
			},
		},
	})
