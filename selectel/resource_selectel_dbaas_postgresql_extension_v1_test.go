...
func TestAccDBaaSPostgreSQLExtensionV1Basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDBaaSPostgreSQLExtensionV1Basic(projectName, datastoreName, userName, userPassword, databaseName, extensionName, nodeCount),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckVPCV2ProjectExists("selectel_vpc_project_v2.project_tf_acc_test_1", &project),
					testAccCheckDBaaSExtensionV1Exists("selectel_dbaas_postgresql_extension_v1.extension_tf_acc_test_1", &dbaasExtension),
					resource.TestCheckResourceAttrSet("selectel_dbaas_postgresql_extension_v1.extension_tf_acc_test_1", "available_extension_id"),
					resource.TestCheckResourceAttrSet("selectel_dbaas_postgresql_extension_v1.extension_tf_acc_test_1", "datastore_id"),
					resource.TestCheckResourceAttrSet("selectel_dbaas_postgresql_extension_v1.extension_tf_acc_test_1", "database_id"),
				),
			},
		},
	})
...
func testAccDBaaSPostgreSQLExtensionV1Basic(projectName, datastoreName, userName, userPassword, databaseName, extensionName string, nodeCount int) string {
	return fmt.Sprintf(`
...
resource "selectel_dbaas_postgresql_extension_v1" "extension_tf_acc_test_1" {
  project_id = "${selectel_vpc_project_v2.project_tf_acc_test_1.id}"
  region = "ru-3"
