		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("selectel_iam_serviceuser_v1.serviceuser_tf_acc_test_1", "role.0.role_name", "member"),
					resource.TestCheckResourceAttr("selectel_iam_serviceuser_v1.serviceuser_tf_acc_test_1", "role.0.scope", "account"),
					resource.TestCheckResourceAttr("selectel_iam_serviceuser_v1.serviceuser_tf_acc_test_1", "role.1.role_name", "billing"),
					resource.TestCheckResourceAttr("selectel_iam_serviceuser_v1.serviceuser_tf_acc_test_1", "role.1.scope", "account"),
				),
			},
			{
				Config: testAccIAMV1ServiceUserBasic(serviceUserName, serviceUserPassword),
