...
* `subnet_id` - (Required) Unique identifier of the associated subnet. Changing this creates a new datastore. For a public subnet, retrieved from the [selectel_vpc_subnet_v2](https://registry.terraform.io/providers/selectel/selectel/latest/docs/resources/vpc_subnet_v2) resource. For a private subnet, retrieved from the [openstack_networking_subnet_v2](https://registry.terraform.io/providers/terraform-provider-openstack/openstack/latest/docs/resources/networking_subnet_v2) resource of the OpenStack provider.
